...
public class ARNativeOSGActivity extends AppCompatActivity {

    private static final String TAG = "ARNativeOSG";

    // Load the native libraries.
    static {
        System.loadLibrary("c++_shared");
        System.loadLibrary("ARNativeOSG");
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arnative_osg);

        ARNativeOSGActivity.nativeCreate(this);
    ...
    public void onStart()
    {
        ...
        ARNativeOSGActivity.nativeStart();
    }
    ...
    public void onStop() {
        ...
        ARNativeOSGActivity.nativeStop();
    }
    ...
    public void onDestroy()
    {
        ...
        ARNativeOSGActivity.nativeDestroy();
    }
