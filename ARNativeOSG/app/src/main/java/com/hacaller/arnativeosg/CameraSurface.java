...
import com.hacaller.arnativeosg.ARNativeOSGActivity;
import com.hacaller.arnativeosg.R;
...
public class CameraSurface extends SurfaceView implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    private static final String TAG = "com.hacaller.arnativeosg.CameraSurface";
